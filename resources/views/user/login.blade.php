                ...
                <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                    ...
                    <form class="space-y-4 md:space-y-6" action="{{ route('user.login') }}" method="post">
                        ...
                        <div class="flex items-center justify-between">
                            ...
                            <a href="#"
                                class="text-sm font-medium text-primary-600 hover:underline dark:text-primary-500 text-blue-500">Забыли
                                пароль?</a>
                                @error('password')
                                <p style="color: red"> {{ $message }}</p>
                            @enderror
                        ...
                        <p class="text-sm font-light text-gray-500 dark:text-gray-400">
                          У вас еще нет учетной записи?  <a href="{{ route('user.register') }}"
                                class="font-medium text-primary-600 hover:underline dark:text-primary-500 text-blue-500">Зарегистрируйтесь</a>
                        </p>
                    </form>
                </div>
            </div>
