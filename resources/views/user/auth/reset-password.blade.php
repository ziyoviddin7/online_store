    ...
    <div class="row hp-authentication-page d-flex flex-column">
        <div class="position-absolute w-100 h-100" style="top: 0px; left: 0px; z-index: -1;">
            <svg width="1440" height="1080" viewBox="0 0 1440 1080" fill="none" xmlns="http://www.w3.org/2000/svg"
                class="hp-stroke-color-dark-80 w-100 h-100">
                <path opacity="0.5"
                    ...
                    stroke="#F7FAFC" stroke-width="100"></path>
            </svg>
        </div>

        <div class="col-12">
            <div
                class="row px-16 px-sm-64 py-16 mb-48 border-bottom hp-border-color-dark-70 align-items-center justify-content-between">
        ...
        <div class="px-32 flex-shrink-1 col d-flex">
            <div class="row h-100 m-auto w-100 align-items-center" style="max-width: 410px;">
                <div class="col-12">
                    ...
                    <form action="{{ route('password.update') }}" method="post" class="mt-16 mt-sm-32 mb-8">
                        @csrf
                        ...
                        <div class="mb-24">
                            ...
                            <input name="email" type="email" class="form-control" id="recoverEmail"
                        ...
                        <div class="mb-24">
                            ...
                            <input name="password_confirmation" type="password" class="form-control"
                                id="resetConfirmPassword" placeholder="At least 6 characters">
                            @error('password')
                                <p style="color: red"> {{ $message }}</p>
                            @enderror
                        </div>
