            ...
            <div class="hp-bg-black-bg py-32 py-sm-64 px-24 px-sm-48 px-md-80 position-relative overflow-hidden hp-page-content" style="border-radius: 32px;">
                ...
                <div class="row">
                    <div class="col-sm-6 col-12">
                        <div class="row">
                            <div class="col-12">
                                <h1 class="mb-0 hp-text-color-black-0"> Advance Cards </h1>
                            </div>
                            ...
                            <div class="col-12">
                                <ol class="breadcrumb mt-24">
                                    ...
                                    <li class="breadcrumb-item">
                                        <a href="javascript:;">
                                            <span class="hp-text-color-black-0"> Main </span>
                                        </a>
                                    </li>
                                    ...
                                    <li class="breadcrumb-item">
                                        <a href="javascript:;">
                                            <span class="hp-text-color-black-0"> Widgets </span>
                                        </a>
                                    </li>
                                    ...
                                    <li class="breadcrumb-item">
                                        <a href="javascript:;">
                                            <span class="hp-text-color-black-0"> YodaCards </span>
                                        </a>
                                    </li>
                                    ...
                                    <li class="breadcrumb-item">
                                        <a href="javascript:;">
                                            <span class="hp-text-color-black-0"> Advance </span>
                                        </a>
                                    </li>
                            ...
                            <div class="col-12">
                                <p class="h5 mb-0 mt-24 hp-text-color-black-0"> You can find special cards we designed for Yoda Admin Template </p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="row g-32">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="row g-16">
                                ...
                                <div class="col">
                                    <h3 class="mb-4 mt-8">243<span class="hp-badge-text ms-8 text-primary hp-text-color-dark-primary-2">+3%</span></h3>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="row g-16">
                                ...
                                <div class="col">
                                    <h3 class="mb-4 mt-8">1,243<span class="hp-badge-text ms-8 text-secondary">+4%</span></h3>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="row g-16">
                                ...
                                <div class="col">
                                    <h3 class="mb-4 mt-8">$ 323<span class="hp-badge-text ms-8 text-warning">-1.4%</span></h3>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="row g-16">
                                ...
                                <div class="col">
                                    <h3 class="mb-4 mt-8">$ 1,32<span class="hp-badge-text ms-8 text-danger">+3%</span></h3>
                    ...
                    <div class="hp-card-6 hp-eCommerceCardOne">
                        <div class="rounded overflow-hidden border border-black-40 hp-border-color-dark-80 bg-black-0 hp-bg-color-dark-100 h-100">
                            <div class="text-center bg-black-10 hp-bg-color-dark-80 hp-card-2 d-flex align-items-center justify-content-center">
                                <img src="../../../app-assets/img/product/ecommerce-product-img-1.png" alt="Rales Wireless Earbuds Bluetooth 5.0">
                            </div>

                            <div class="p-24">
                                <div class="mb-16 mt-8">
                                    <h3 class="mb-4">$69.00</h3>
                                    <p class="mb-0 me-4 fw-medium text-black-60 hp-text-color-dark-50 text-decoration-line-through hp-badge">$79.00</p>
                                </div>

                                <div class="mb-8">
                                    <p class="mb-4 text-black-100 hp-text-color-dark-0 hp-p1-body">Rales Wireless Earbuds Bluetooth 5.0</p>
                                    <p class="mb-0 hp-caption text-black-60 hp-text-color-dark-50">By Urbanears</p>
                                </div>
                                ...
                                <div class="mt-16">
                                    <ul class="row g-6">
                                        ...
                                        <li class="col hp-flex-none w-auto">
                                            <i class="ri-star-fill text-black-40 hp-text-color-dark-70" style="font-size: 20px;"></i>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                ...
                <div class="col-12 col-md-4">
                    <div class="hp-card-6 hp-eCommerceCardOne">
                        <div class="rounded overflow-hidden border border-black-40 hp-border-color-dark-80 bg-black-0 hp-bg-color-dark-100 h-100">
                            <div class="text-center bg-black-10 hp-bg-color-dark-80 hp-card-2 d-flex align-items-center justify-content-center">
                                <img src="../../../app-assets/img/product/ecommerce-product-img-2.png" alt="Rales Wireless Earbuds Bluetooth 5.0">
                            </div>
                            ...
                            <div class="card hp-card-2">
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col-12">
                                            <div class="row justify-content-between hp-categoriesOfTheWeek g-24">
                                                <div class="col-6" style="padding-left: 12px; padding-right: 12px;">
                                                    <div class="d-flex align-items-center">
                                                        <div class="bg-black-20 hp-bg-color-dark-70 p-4 hp-img-container">
                                                            <img src="../../../app-assets/img/product/watch-1.png" alt="Sports">
                                                        </div>

                                                        <div>
                                                            <p class="mb-4 text-black-100 hp-text-color-dark-0 hp-badge-text fw-medium">9K Sales</p>
                                                            <p class="mb-0 text-black-80 hp-text-color-dark-30 hp-input-description">Sports</p>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-6" style="padding-left: 12px; padding-right: 12px;">
                                                    <div class="d-flex align-items-center">
                                                        <div class="bg-black-20 hp-bg-color-dark-70 p-4 hp-img-container">
                                                            <img src="../../../app-assets/img/product/xbox-1.png" alt="Tech">
                                                        </div>

                                                        <div>
                                                            <p class="mb-4 text-black-100 hp-text-color-dark-0 hp-badge-text fw-medium">15K Sales</p>
                                                            <p class="mb-0 text-black-80 hp-text-color-dark-30 hp-input-description">Tech</p>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-6" style="padding-left: 12px; padding-right: 12px;">
                                                    <div class="d-flex align-items-center">
                                                        <div class="bg-black-20 hp-bg-color-dark-70 p-4 hp-img-container">
                                                            <img src="../../../app-assets/img/product/wireless-bluetooth-1.png" alt="Home">
                                                        </div>

                                                        <div>
                                                            <p class="mb-4 text-black-100 hp-text-color-dark-0 hp-badge-text fw-medium">10K Sales</p>
                                                            <p class="mb-0 text-black-80 hp-text-color-dark-30 hp-input-description">Home</p>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-6" style="padding-left: 12px; padding-right: 12px;">
                                                    <div class="d-flex align-items-center">
                                                        <div class="bg-black-20 hp-bg-color-dark-70 p-4 hp-img-container">
                                                            <img src="../../../app-assets/img/product/white-cam-1.png" alt="Style">
                                                        </div>

                                                        <div>
                                                            <p class="mb-4 text-black-100 hp-text-color-dark-0 hp-badge-text fw-medium">12K Sales</p>
                                                            <p class="mb-0 text-black-80 hp-text-color-dark-30 hp-input-description">Style</p>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                            ...
                            <div class="card hp-card-4">
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-12">
                                            <div class="row align-items-start justify-content-between">
                                                <h5 class="mb-24">Best Selling Categories</h5>
                                            </div>
                                        </div>
                                                            ...
                                                            <div class="row g-8 align-items-center">
                                                                <div class="col hp-flex-none w-auto">
                                                                    <div class="bg-black-20 hp-bg-color-dark-70 p-4 rounded text-center" style="width: 48px; height: 48px;">
                                                                        <img src="../../../app-assets/img/product/watch-1.png" alt="Technology">
                                                                    </div>
                                                                </div>

                                                                <div class="col hp-flex-none w-auto">
                                                                    <p class="mb-4 text-black-100 hp-text-color-dark-0 hp-badge-text fw-medium">5KSales</p>
                                                                    <p class="mb-0 text-black-80 hp-text-color-dark-30 hp-input-description">Technology</p>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="row align-items-center justify-content-between">
                                                        <div class="col hp-flex-none w-auto">
                                                            <div class="row g-8 align-items-center">
                                                                <div class="col hp-flex-none w-auto">
                                                                    <div class="bg-black-20 hp-bg-color-dark-70 p-4 rounded text-center" style="width: 48px; height: 48px;">
                                                                        <img src="../../../app-assets/img/product/wireless-bluetooth-1.png" alt="Music">
                                                                    </div>
                                                                </div>

                                                                <div class="col hp-flex-none w-auto">
                                                                    <p class="mb-4 text-black-100 hp-text-color-dark-0 hp-badge-text fw-medium">1.2KSales</p>
                                                                    <p class="mb-0 text-black-80 hp-text-color-dark-30 hp-input-description">Music</p>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="row align-items-center justify-content-between">
                                                        <div class="col hp-flex-none w-auto">
                                                            <div class="row g-8 align-items-center">
                                                                <div class="col hp-flex-none w-auto">
                                                                    <div class="bg-black-20 hp-bg-color-dark-70 p-4 rounded text-center" style="width: 48px; height: 48px;">
                                                                        <img src="../../../app-assets/img/product/xbox-1.png" alt="Gaming">
                                                                    </div>
                                                                </div>

                                                                <div class="col hp-flex-none w-auto">
                                                                    <p class="mb-4 text-black-100 hp-text-color-dark-0 hp-badge-text fw-medium">560Sales</p>
                                                                    <p class="mb-0 text-black-80 hp-text-color-dark-30 hp-input-description">Gaming</p>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="row align-items-center justify-content-between">
                                                        <div class="col hp-flex-none w-auto">
                                                            <div class="row g-8 align-items-center">
                                                                <div class="col hp-flex-none w-auto">
                                                                    <div class="bg-black-20 hp-bg-color-dark-70 p-4 rounded text-center" style="width: 48px; height: 48px;">
                                                                        <img src="../../../app-assets/img/product/white-cam-1.png" alt="Photography">
                                                                    </div>
                                                                </div>

                                                                <div class="col hp-flex-none w-auto">
                                                                    <p class="mb-4 text-black-100 hp-text-color-dark-0 hp-badge-text fw-medium">1KSales</p>
                                                                    <p class="mb-0 text-black-80 hp-text-color-dark-30 hp-input-description">Photography</p>
                                                                </div>
                                                            </div>
                                                        </div>
                                    ...
                                    <div class="row">
                                        <div class="col-12">
                                            <div class="row mx-0 align-items-start justify-content-between">
                                                <span class="badge bg-primary-4 hp-bg-dark-primary text-primary hp-text-color-dark-primary-2 border-none w-auto px-16 fw-medium">Featured</span>
                                        ...
                                        <div class="col-12">
                                            <div class="text-center">
                                                <a href="app-ecommerce-product-detail.html" class="d-block">
                                                    <img src="../../../app-assets/img/product/white-cam-card.png" alt="4K Action Cam" style="max-height: 191px;">
                                                </a>
                                            </div>
                                            ...
                                            <div class="col-12 mb-24">
                                                <p class="mb-0 me-4 hp-text-color-dark-0 hp-p1-body fw-medium">Digital Camera White Adition</p>
                                                <p class="mb-0 hp-text-color-dark-0 hp-caption fw-normal">Touch LCD Screen Zero Ink Camera</p>
                                            </div>

                                            <div class="row">
                                                <div class="col-12 col-sm-6">
                                                    <a href="app-ecommerce-product-detail.html">
                                                        <button type="button" class="btn btn-ghost btn-primary w-100">
                                ...
                                <div class="card-body py-16">
                                    <div class="row">
                                        <div class="col-12 mb-8">
                                            <div class="d-flex align-items-center">
                                                <i class="ri-ghost-smile-line text-primary me-8" style="font-size: 24px;"></i>
                                            ...
                                            <div class="row align-items-center justify-content-between">
                                                <div class="col hp-flex-none w-auto">
                                                    <div class="avatar-group" data-max="5">
                                                        <div class="avatar-item avatar-sm d-flex align-items-center justify-content-center rounded-circle">
                                                            <img src="../../../app-assets/img/memoji/memoji-1.png">
                                                        </div>

                                                        <div class="avatar-item avatar-sm d-flex align-items-center justify-content-center bg-danger-4 hp-bg-dark-danger hp-text-color-danger-1 rounded-circle">
                                                            A
                                                        </div>
                                                        ...
                                                        <div class="avatar-item avatar-sm d-flex align-items-center justify-content-center bg-primary-4 hp-bg-dark-primary text-primary hp-text-color-dark-primary-2 rounded-circle">
                                                            W
                                                        </div>

                                                        <div class="avatar-item avatar-sm d-flex align-items-center justify-content-center bg-warning-4 hp-bg-dark-warning hp-text-color-warning-1 rounded-circle">
                                                            X
                                                        </div>
                                                        ...
                                                        <div class="avatar-item avatar-sm d-flex align-items-center justify-content-center hp-bg-secondary-4 hp-bg-dark-secondary hp-text-color-secondary-1 rounded-circle">
                                                            Y
                                                        </div>

                                                        <div class="avatar-item avatar-sm avatar-item-max-count d-none bg-danger-4 hp-bg-dark-danger text-danger">
                                                            <span></span>
                                                ...
                                                <div class="col hp-flex-none w-auto">
                                                    <button type="button" class="btn btn-text p-0 bg-transparent">
                ...
                <div class="col-12 col-xl-4">
                    <div class="row g-32">
                        <div class="col-12 col-sm-6 col-xl-12">
                            <div class="card hp-card-3 hp-eCommerceCardOne">
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-12 mb-8">
                                            <div class="row align-items-start justify-content-between">
                                                ...
                                                <div class="col hp-flex-none w-auto">
                                                    <p class="hp-badge-text text-black-80 hp-text-color-dark-30 mb-0">May 2021</p>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-12">
                                            <div class="row align-items-center justify-content-between mt-12">
                                                <div class="col-6">
                                                    <div class="d-flex align-items-center">
                                                        <div class="me-8">
                                                            <img src="../../../app-assets/img/browser/chrome.svg" alt="Google Chrome">
                                                        </div>

                                                        <p class="hp-p1-body mb-0">Google Chrome</p>
                                                    </div>
                                                </div>

                                                <div class="col-6">
                                                    <div class="d-flex align-items-center justify-content-end position-relative">
                                                        <p class="hp-badge-text mb-0 me-8">50.2%</p>
                                                        <div id="browser-chrome-chart"></div>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row align-items-center justify-content-between mt-12">
                                                <div class="col-6">
                                                    <div class="d-flex align-items-center">
                                                        <div class="me-8">
                                                            <img src="../../../app-assets/img/browser/firefox.svg" alt="Mozila Firefox">
                                                        </div>

                                                        <p class="hp-p1-body mb-0">Mozila Firefox</p>
                                                    </div>
                                                </div>

                                                <div class="col-6">
                                                    <div class="d-flex align-items-center justify-content-end position-relative">
                                                        <p class="hp-badge-text mb-0 me-8">12.5%</p>
                                                        <div id="browser-firefox-chart"></div>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row align-items-center justify-content-between mt-12">
                                                <div class="col-6">
                                                    <div class="d-flex align-items-center">
                                                        <div class="me-8">
                                                            <img src="../../../app-assets/img/browser/safari.svg" alt="Apple Safari">
                                                        </div>

                                                        <p class="hp-p1-body mb-0">Apple Safari</p>
                                                    </div>
                                                </div>

                                                <div class="col-6">
                                                    <div class="d-flex align-items-center justify-content-end position-relative">
                                                        <p class="hp-badge-text mb-0 me-8">24.8%</p>
                                                        <div id="browser-safari-chart"></div>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row align-items-center justify-content-between mt-12">
                                                <div class="col-6">
                                                    <div class="d-flex align-items-center">
                                                        <div class="me-8">
                                                            <img src="../../../app-assets/img/browser/edge.svg" alt="Microsoft Edge">
                                                        </div>

                                                        <p class="hp-p1-body mb-0">Microsoft Edge</p>
                                                    </div>
                                                </div>

                                                <div class="col-6">
                                                    <div class="d-flex align-items-center justify-content-end position-relative">
                                                        <p class="hp-badge-text mb-0 me-8">4.7%</p>
                                                        <div id="browser-edge-chart"></div>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row align-items-center justify-content-between mt-12">
                                                <div class="col-6">
                                                    <div class="d-flex align-items-center">
                                                        <div class="me-8">
                                                            <img src="../../../app-assets/img/browser/opera.svg" alt="Opera">
                                                        </div>

                                                        <p class="hp-p1-body mb-0">Opera</p>
                                                    </div>
                                                </div>

                                                <div class="col-6">
                                                    <div class="d-flex align-items-center justify-content-end position-relative">
                                                        <p class="hp-badge-text mb-0 me-8">7.8%</p>
                                                        <div id="browser-opera-chart"></div>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                        ...
                        <div class="col-12 col-sm-6 col-xl-12">
                            <div class="card hp-card-3">
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-12">
                                            <div class="text-center">
                                                <img src="../../../app-assets/img/product/watch-card.png" alt="Xbox Wireless Game">
                                            </div>

                                            <div class="row justify-content-center">
                                                <div class="col-12 text-center">
                                                    <h5 class="mb-0 mt-12 me-4 text-black-100 hp-text-color-dark-0 hp-p1-body fw-medium">Xbox Wireless Game</h5>
                                                    <h3 class="mb-0 my-8 text-primary">£399</h3>
                                                    <div class="d-flex align-items-center justify-content-center">
                                                        <i class="ri-arrow-right-up-line text-success"></i>
                                                        <p class="mb-0 me-8 hp-badge-text text-success">+4</p>
                ...
                <div class="col-12 col-md-6">
                    <div class="card hp-card-3">
                        <div class="card-body">
                            ...
                            <div class="row mt-32">
                                <div class="col hp-flex-none w-auto me-64">
                                    <p class="mb-0 hp-caption text-black-80 hp-text-color-dark-30">Name on Card</p>
                ...
                <div class="col-12 col-xl-4">
                    <div class="card hp-card-6">
                        <div class="card-body">
                            <div class="row">
                                <div class="col-12 text-center">
                                    <img src="../../../app-assets/img/illustrations/time-management-1.svg" alt="Buy Pro Account to explore Premium Features" class="hp-dark-none">
                                    <img src="../../../app-assets/img/illustrations/time-management-1-dark.svg" alt="Buy Pro Account to explore Premium Features" class="hp-dark-block mx-auto">

                                    <h4 class="my-24 me-4 fw-bold">Buy Pro Account to explore Premium Features</h4>
                ...
                <div class="col-12 col-xl-4">
                    <div class="card hp-card-6">
                        <div class="card-body">
                            <div class="row">
                                <div class="col-12 text-center">
                                    <img src="../../../app-assets/img/illustrations/growth.svg" alt="Upgrade Account" class="hp-dark-none">
                                    <img src="../../../app-assets/img/illustrations/growth-dark.svg" alt="Upgrade Account" class="hp-dark-block mx-auto">

                                    <h3 class="mt-24 mb-16 me-4">Upgrade Account</h3>
                                    <p class="hp-p1-body mb-0">5 integrations, 30 team members, <br> advanced<span class="mx-4 text-primary hp-text-color-dark-primary-2 fw-medium">features</span>for teams.</p>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-12 col-xl-4">
                    <div class="card hp-card-6">
                        <div class="card-body">
                            <div class="row">
                                <div class="col-12 text-center">
                                    <img src="../../../app-assets/img/illustrations/newsletter-1.svg" alt="Upgrade Account" class="hp-dark-none">
                                    <img src="../../../app-assets/img/illustrations/newsletter-1-dark.svg" alt="Upgrade Account" class="hp-dark-block mx-auto">

                                    <form class="mt-36">
                                        <div class="mb-16">
                                            <label for="subscribeEmail" class="w-100 text-start form-label">
                                                <span class="text-danger me-8">*</span>Email:
                                            </label>
                                            <input type="email" class="form-control" id="subscribeEmail" placeholder="Please enter your email" aria-describedby="emailHelp">
                                        </div>
                    ...
                    <div class="card hp-card-6">
                        <div class="card-body">
                            <div class="position-absolute" style="left: 20px; bottom: 0px;">
                                <svg class="hp-stroke-color-dark-0" width="302" height="90" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M296 96.824 172.381 9l18.207 70.449-83.051-60.34L176.214 142 63.136 63.021l27.79 73.924L5 90.505" stroke="#000000" stroke-width="20" stroke-linejoin="bevel"></path>
                                </svg>
                            </div>

                            <h1 class="mb-16 hp-text-color-black-bg hp-text-color-dark-0"> Upgrade <br> Account </h1>
                            <p class="h3 fw-normal hp-text-color-black-100 hp-text-color-dark-10 mb-0">
                                5 integrations, 30 <br>
                                team members, <br>
                                advanced
                                <span class="mx-4 hp-text-color-primary-1 hp-text-color-dark-primary-2"> features </span>
                                <br>
                                for teams.
                            </p>
                        </div>
                ...
                <div class="col-12 col-xl-4">
                    <div class="card hp-card-6 overflow-hidden">
                        <div class="card-body">
                            <div class="row flex-column justify-content-between">
                                <div class="text-center mt-24 col-12">
                                    <div class="position-absolute" style="left: -8px; right: -8px; top: 35%; transform: translate(0px, -50%);">
                                        <img src="../../../app-assets/img/dashboard/line.svg" alt="Upgrade Account" class="w-100">
                                    </div>
                                    <img src="../../../app-assets/img/logo/logo-blue-shadow.svg" alt="Upgrade Account" class="position-relative">
                                </div>

                                <div class="text-center mt-42 col-12">
                                    <h3 class="mb-12">Upgrade Account</h3>
                                    <p class="hp-p1-body mb-0">
                                        5 integrations, 30 team members, <br>
                                        advanced
                                        <span class="hp-text-color-primary-1 mx-4 hp-text-color-dark-primary-2"> features </span>
                                        for teams.
                                    </p>
                                </div>
                            </div>
                ...
                <div class="col-12 col-xl-4">
                    <div class="card hp-card-6">
                        <div class="card-body">
                            <div class="row flex-column mx-n24 justify-content-between">
                                <div class="text-center mt-12 mb-64 mb-md-0 px-0 col">
                                    <img src="../../../app-assets/img/dashboard/line.svg" alt="Upgrade Account" class="w-100 hp-dark-block">
                                    <img src="../../../app-assets/img/dashboard/lineDark.svg" alt="Upgrade Account" class="w-100 hp-dark-none">
                                </div>

                                <div class="text-center mt-96 pt-12 col-12">
                                    <h3 class="mb-12">Upgrade Account</h3>
                                    <p class="hp-p1-body mb-0">
                                        5 integrations, 30 team members, <br>
                                        advanced
                                        <span class="hp-text-color-primary-1 hp-mx-4 hp-text-color-dark-primary-2"> features </span>
                                        for teams.
                                    </p>
                                </div>
                            </div>
                                ...
                                <div class="card-body">
                                    <div class="row g-32">
                                        <div class="col-12 col-md-5 mb-24 mb-md-0">
                                            <div class="row mx-0 align-items-start justify-content-between">
                                                <span class="badge bg-primary-4 hp-bg-dark-primary text-primary hp-text-color-dark-primary-2 border-none w-auto py-4 fw-medium">Featured</span>
                                            ...
                                            <div class="col-12 text-center">
                                                <a href="app-ecommerce-product-detail.html">
                                                    <img src="../../../app-assets/img/product/xbox-1.png" alt="Xbox Wireless Game Console">
                                                </a>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-12 col-md-7">
                                            ...
                                            <div class="my-8">
                                                <h4 class="mb-4">Xbox Wireless Game Console</h4>
                                                <p class="hp-caption mb-0 text-black-60">By <span class="text-black-80 hp-text-color-dark-30">Microsoft</span></p>
                                            </div>
                                            ...
                                            <div class="d-flex align-items-center mt-8 mb-12 mb-sm-0">
                                                <p class="h5 w-auto px-0 mb-0 me-4 text-primary fw-medium">$39.00</p>
                                                <p class="w-auto px-0 mb-0 text-black-60 text-decoration-line-through hp-input-description">$59.00</p>
                                            </div>
                                ...
                                <div class="card-body">
                                    <div class="row g-32">
                                        <div class="col-12 col-md-4 mb-24 mb-md-0">
                                            ...
                                            <div class="col-12 text-center">
                                                <a href="app-ecommerce-product-detail.html">
                                                    <img src="../../../app-assets/img/product/white-cam-card.png" alt="Digital Camera White Adition">
                                                </a>
                                            </div>
                                        </div>
                                            ...
                                            <div class="row">
                                                <div class="col-12 col-sm-6">
                                                    ...
                                                    <div class="my-8">
                                                        ...
                                                        <p class="hp-caption mb-0 text-black-60">By <span class="text-black-80 hp-text-color-dark-30">Polaroid</span></p>
                                                    </div>
                                                ...
                                                <div class="col-12 col-sm-6">
                                                    <div class="text-sm-end mt-24 mt-sm-0">
                                                        <span class="h3 mb-8 text-primary fw-medium">$39.00</span>

                                                        <div class="d-flex align-items-center justify-content-end mb-4">
                                                            <i class="ri-checkbox-circle-fill text-success me-4"></i>
                                                            <p class="mb-0 hp-text-color-dark-0">Flexible credit available</p>
                                                        </div>
                                                        ...
                                                        <a href="app-ecommerce-product-detail.html">
                                                            <button type="button" class="btn btn-ghost btn-primary w-100 mt-24 mb-8">
                                                                <span>Check Detail</span>
                                                            </button>
                                                        </a>
                        ...
                        <div class="col-12">
                            <div class="card hp-card-3 hp-eCommerceCardOne">
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-12 text-center">
                                            <h5 class="mb-4 hp-eCommerceCardOne-text-overlay">Xbox Wireless Game Console</h5>
                                            <p class="hp-caption mb-0 text-black-60 hp-text-color-dark-50">By <span class="text-black-80 hp-text-color-dark-30"> Microsoft</span></p>

                                            <img src="../../../app-assets/img/product/xbox-1.png" alt="Xbox Wireless Game Console" style="max-height: 120px;">
                                            ...
                                            <div class="d-flex align-items-center justify-content-center flex-wrap">
                                                ...
                                                <span class="h3 mb-0 text-primary fw-medium">$39.00</span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="row">
                                        <div class="col-12 text-center">
                                            <div class="d-flex align-items-start justify-content-between">
                                                <span class="badge text-danger bg-danger-4 hp-bg-dark-danger border-0">%25 Discount</span>
                                            ...
                                            <img class="my-8" src="../../../app-assets/img/product/xbox-1.png" alt="Xbox Wireless Game Console" style="max-height: 120px;">
                                            <h3 class="mb-8  text-primary fw-500">$39.00</h3>
                                            <h5 class="mb-4 hp-eCommerceCardOne-text-overlay">Xbox Wireless Game Console</h5>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="table-responsive">
                                <table class="table align-middle">
                                    <thead>
                                        <tr>
                                            <th>
                                                <span class="hp-badge-size fw-normal text-black-60 hp-text-color-dark-50 text-uppercase">Order Id</span>
                                            </th>
                                            <th>
                                                <span class="hp-badge-size fw-normal text-black-60 hp-text-color-dark-50 text-uppercase">Product</span>
                                            </th>
                                            <th>
                                                <span class="hp-badge-size fw-normal text-black-60 hp-text-color-dark-50 text-uppercase">Date</span>
                                            </th>
                                            <th>
                                                <span class="hp-badge-size fw-normal text-black-60 hp-text-color-dark-50 text-uppercase">Status</span>
                                            </th>
                                            <th>
                                                <span class="hp-badge-size fw-normal text-black-60 hp-text-color-dark-50 text-uppercase">Price</span>
                                            </th>
                                        </tr>
                                    </thead>
                                    ...
                                    <tbody>
                                        <tr>
                                            <td>
                                                <span class="text-color-dark-0">#1341234123</span>
                                            </td>
                                            <td>
                                                <div class="bg-black-20 hp-bg-color-dark-70 hp-img-container rounded text-center p-4">
                                                    <img src="../../../app-assets/img/product/watch-1.png " alt="Product">
                                                </div>
                                            </td>
                                            <td>
                                                <span class="text-color-dark-0">04/05/2021</span>
                                            </td>
                                            <td>
                                                <div class="badge bg-primary-4 hp-bg-dark-primary text-primary hp-text-color-dark-primary-2 border-primary">PENDING</div>
                                            </td>
                                            <td>
                                                <span class="text-color-dark-0">$200</span>
                                            </td>
                                        </tr>

                                        <tr>
                                            <td>
                                                <span class="text-color-dark-0">#1123412123</span>
                                            </td>
                                            <td>
                                                <div class="bg-black-20 hp-bg-color-dark-70 hp-img-container rounded text-center p-4">
                                                    <img src="../../../app-assets/img/product/wireless-bluetooth-1.png " alt="Product">
                                                </div>
                                            </td>
                                            <td>
                                                <span class="text-color-dark-0">04/05/2021</span>
                                            ...
                                            <td>
                                                <div class="badge bg-warning-4 hp-bg-dark-warning text-warning border-warning">DELAYED</div>
                                            </td>
                                            <td>
                                                <span class="text-color-dark-0">$345</span>
                                            </td>
                                        </tr>

                                        <tr>
                                            <td>
                                                <span class="text-color-dark-0">#242367123</span>
                                            </td>
                                            <td>
                                                <div class="bg-black-20 hp-bg-color-dark-70 hp-img-container rounded text-center p-4">
                                                    <img src="../../../app-assets/img/product/xbox-1.png " alt="Product">
                                                </div>
                                            </td>
                                            <td>
                                                <span class="text-color-dark-0">04/05/2021</span>
                                            ...
                                            <td>
                                                <span class="text-color-dark-0">$277</span>
                                            </td>
                                        </tr>

                                        <tr>
                                            <td>
                                                <span class="text-color-dark-0">#255167123</span>
                                            </td>
                                            <td>
                                                <div class="bg-black-20 hp-bg-color-dark-70 hp-img-container rounded text-center p-4">
                                                    <img src="../../../app-assets/img/product/white-cam-1.png " alt="Product">
                                                </div>
                                            </td>
                                            <td>
                                                <span class="text-color-dark-0">04/05/2021</span>
                                            ...
                                            <td>
                                                <div class="badge bg-success-4 hp-bg-dark-success text-success border-success">DONE</div>
                                            </td>
                                            <td>
                                                <span class="text-color-dark-0">$100</span>
                                            </td>
                                        </tr>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="bg-black-20 hp-bg-color-dark-70 hp-img-container rounded text-center p-4">
                                                    <img src="../../../app-assets/img/product/3d-glasses-1.png " alt="Product">
                                                </div>
                                            </td>
                                            <td>
                                                <span class="text-color-dark-0">04/05/2021</span>
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="d-flex align-items-center justify-content-between mb-32">
                                        <div class="d-flex align-items-center">
                                            <h5 class="mb-0 me-8">Subscribe Goal</h5>
                                    ...
                                    <div class="row g-24">
                                        <div class="col-12">
                                            <div class="row align-items-center gx-16 me-16">
                                                <div class="col hp-flex-none w-auto">
                                                    <div class="hp-social-media-logo-wrapper bg-primary-2">
                                                        <i class="ri-linkedin-fill text-black-0 hp-social-media-logo"></i>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col">
                                                    ...
                                                    <div class="d-flex align-items-center">
                                                        <div class="progress flex-grow-1" style="height: 4px;">
                                                            <div class="progress-bar bg-primary-2" role="progressbar" style="width: 30%;" aria-valuenow="30" aria-valuemin="0" aria-valuemax="100"></div>
                                                        </div>

                                                        <span class="text-black-80 ms-6">30%</span>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="row align-items-center gx-16 me-16">
                                                <div class="col hp-flex-none w-auto">
                                                    <div class="hp-social-media-logo-wrapper bg-primary">
                                                        <i class="ri-facebook-fill text-black-0 hp-social-media-logo"></i>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="row align-items-center gx-16 me-16">
                                                <div class="col hp-flex-none w-auto">
                                                    <div class="hp-social-media-logo-wrapper bg-danger-1">
                                                        <i class="ri-instagram-fill text-black-0 hp-social-media-logo"></i>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col">
                                                    ...
                                                    <div class="d-flex align-items-center">
                                                        <div class="progress flex-grow-1" style="height: 4px;">
                                                            <div class="progress-bar bg-danger-1" role="progressbar" style="width: 30%;" aria-valuenow="30" aria-valuemin="0" aria-valuemax="100"></div>
                                                        </div>
                                            ...
                                            <div class="row align-items-center gx-16 me-16">
                                                <div class="col hp-flex-none w-auto">
                                                    <div class="hp-social-media-logo-wrapper bg-info-1">
                                                        <i class="ri-twitter-fill text-black-0 hp-social-media-logo"></i>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col">
                                                    ...
                                                    <div class="d-flex align-items-center">
                                                        <div class="progress flex-grow-1" style="height: 4px;">
                                                            <div class="progress-bar bg-info-1" role="progressbar" style="width: 30%;" aria-valuenow="30" aria-valuemin="0" aria-valuemax="100"></div>
                                                        </div>
                                            ...
                                            <div class="row align-items-center gx-16 me-16">
                                                <div class="col hp-flex-none w-auto">
                                                    <div class="hp-social-media-logo-wrapper bg-black-80">
                                                        <svg stroke="currentColor" fill="currentColor" stroke-width="0" role="img" viewBox="0 0 24 24" class="text-black-0 hp-social-media-logo " height="16" width="16" xmlns="http://www.w3.org/2000/svg">
                                                ...
                                                <div class="col">
                                                    ...
                                                    <div class="d-flex align-items-center">
                                                        <div class="progress flex-grow-1" style="height: 4px;">
                                                            <div class="progress-bar bg-black-80" role="progressbar" style="width: 30%;" aria-valuenow="30" aria-valuemin="0" aria-valuemax="100"></div>
                                                        </div>
                ...
                <div class="col-12 col-xl-8">
                    <div class="card hp-card-6 hp-project-table-card">
                        <div class="card-body">
                            ...
                            <div class="table-responsive">
                                <table class="table align-middle mb-0">
                                    <thead>
                                        <tr>
                                            <th>
                                                <span class="hp-badge-size fw-bold text-black-60 hp-text-color-dark-50 text-uppercase">#</span>
                                            </th>
                                            <th>
                                                <span class="hp-badge-size fw-bold text-black-60 hp-text-color-dark-50 text-uppercase">Project Name</span>
                                            </th>
                                            <th>
                                                <span class="hp-badge-size fw-bold text-black-60 hp-text-color-dark-50 text-uppercase">Start Date</span>
                                            </th>
                                            <th>
                                                <span class="hp-badge-size fw-bold text-black-60 hp-text-color-dark-50 text-uppercase">End Date</span>
                                            </th>
                                            <th>
                                                <span class="hp-badge-size fw-bold text-black-60 hp-text-color-dark-50 text-uppercase">Status</span>
                                            </th>
                                            <th>
                                                <span class="hp-badge-size fw-bold text-black-60 hp-text-color-dark-50 text-uppercase">Assign</span>
                                            </th>
                                        </tr>
                                    </thead>
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>
                                                <span class="badge bg-primary-4 hp-bg-dark-primary text-primary hp-text-color-dark-primary-2 border-primary">Work</span>
                                            </td>
                                            <td>
                ...
                <div class="col-12 col-xl-4">
                    <div class="card hp-card-5">
                        <div class="card-body">
                            <span class="badge text-primary hp-text-color-dark-primary-2 border-primary hp-border-color-dark-primary-2 bg-primary-4 hp-bg-dark-primary mb-16">05 May 2021</span>
                            <h5 class="mb-4">Sales Meeting</h5>
                            <p class="hp-p1-body mb-16">2020 Overview of yearly sales over Covid-19 pandemic situation.</p>

                            <p class="hp-badge-text mb-8 text-black-100 hp-text-color-dark-0">Teams</p>
                            <span class="badge text-danger border-danger bg-danger-4 hp-bg-dark-danger">Sales</span>
                            <span class="badge text-info border-info bg-info-4 hp-bg-dark-info mb-16">Marketing</span>

                            <p class="hp-badge-text mb-8 text-black-100 hp-text-color-dark-0">Members</p>
                            <div class="avatar-group" data-max="5">
                                <div class="avatar-item d-flex align-items-center justify-content-center rounded-circle">
                                    <img src="../../../app-assets/img/memoji/memoji-1.png">
                                </div>

                                <div class="avatar-item d-flex align-items-center justify-content-center bg-danger-4 hp-bg-dark-danger hp-text-color-danger-1 rounded-circle">
                                    A
                                </div>
                                ...
                                <div class="avatar-item d-flex align-items-center justify-content-center bg-primary-4 hp-bg-dark-primary text-primary hp-text-color-dark-primary-2 rounded-circle">
                                    W
                                </div>

                                <div class="avatar-item d-flex align-items-center justify-content-center bg-warning-4 hp-bg-dark-warning hp-text-color-warning-1 rounded-circle">
                                    X
                                </div>
                                ...
                                <div class="avatar-item d-flex align-items-center justify-content-center hp-bg-secondary-4 hp-bg-dark-secondary hp-text-color-secondary-1 rounded-circle">
                                    Y
                                </div>
                            ...
                            <button type="button" class="btn btn-primary w-100 mt-16">
                        ...
                        <div class="card-body">
                            ...
                            <ul class="timeline hp-p2-body">
                                <li class="timeline-item">
                                    ...
                                    <div class="timeline-item-content">Create a services site 2015-09-01</div>
                                </li>
                                <li class="timeline-item">
                                    <div class="timeline-item-tail"></div>
                                    <div class="timeline-item-head"></div>
                            ...
                            <div class="row g-24">
                                <div class="col-12">
                                    <div class="row align-items-center justify-content-between">
                                        <div class="col hp-flex-none w-auto">
                                            <div class="d-flex align-items-center">
                                                <i class="ri-shield-keyhole-line text-primary me-16" style="font-size: 24px;"></i>

                                                <div>
                                                    <h5 class="mb-0">Security Setting</h5>
                                                    <p class="mb-0 hp-badge-text fw-normal">Secured by Hypeople</p>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col hp-flex-none w-auto">
                                            <div class="form-check form-switch">
                                                <input class="form-check-input" type="checkbox" name="notification-security-setting" id="notification-security-setting" checked>
                                                <label class="form-check-label" for="notification-security-setting"></label>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-12">
                                    <div class="row align-items-center justify-content-between">
                                        <div class="col hp-flex-none w-auto">
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div>
                                                    ...
                                                    <p class="mb-0 hp-badge-text fw-normal">Hypeople</p>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col hp-flex-none w-auto">
                                            <div class="form-check form-switch">
                                                <input class="form-check-input" type="checkbox" name="notification-wi-fi" id="notification-wi-fi">
                                                <label class="form-check-label" for="notification-wi-fi"></label>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-12">
                                    <div class="row align-items-center justify-content-between">
                                        <div class="col hp-flex-none w-auto">
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div>
                                                    ...
                                                    <p class="mb-0 hp-badge-text fw-normal">Touch ID</p>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col hp-flex-none w-auto">
                                            <div class="form-check form-switch">
                                                <input class="form-check-input" type="checkbox" name="notification-finger-pring" id="notification-finger-pring">
                                                <label class="form-check-label" for="notification-finger-pring"></label>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-12">
                                    <div class="row align-items-center justify-content-between">
                                        <div class="col hp-flex-none w-auto">
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div>
                                                    ...
                                                    <p class="mb-0 hp-badge-text fw-normal">Not recommended</p>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col hp-flex-none w-auto">
                                            <div class="form-check form-switch">
                                                <input class="form-check-input" type="checkbox" name="notification-lock" id="notification-lock" checked>
                                                <label class="form-check-label" for="notification-lock"></label>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="row align-items-center justify-content-between">
                                        ...
                                        <div class="col hp-flex-none w-auto">
                                            <div class="mt-16 mt-sm-0">
                                                <i class="ri-arrow-right-line text-primary lh-1" style="font-size: 24px;"></i>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                ...
                <div class="col-12 col-xl-8">
                    <div class="row g-32">
                                        ...
                                        <div class="mb-4 col-12">
                                            <div class="row align-items-center justify-content-between">
                                                <div class="flex-shrink-1 col">
                                                    <h4 class="mb-8 fw-bold"> Get exclusive discounts for any payment method </h4>
                                                    <p class="hp-p1-body mb-0 hp-text-color-black-100 hp-text-color-dark-0"> by upgrading your plan to premium </p>
                                                </div>

                                                <div class="hp-flex-none w-auto col">
                                                    <button type="button" class="btn float-right mt-16 mt-sm-0 border-0 hp-hover-bg-black-100 hp-bg-black-bg hp-text-color-black-0 hp-hover-bg-dark-10 hp-bg-dark-0 hp-text-color-dark-100 btn-secondary">
                        ...
                        <div class="col-12">
                            <div class="card hp-bg-black-bg hp-border-color-black-40 hp-border-color-dark-80 hp-card-1 hp-upgradePlanCardOne">
                                <div class="card-body">
                                    <div class="position-absolute h-100" style="top: 0px; right: 0px;">
                                        <svg fill="none" xmlns="http://www.w3.org/2000/svg" class="w-100 h-100">
                                            <path d="m394.94 86.299-177.9-100.66 34.328 92.136L131.659 8.35l109.303 155.528L78.423 73.626l47.648 95.459L4.478 118.751" stroke="url(#UpgradePlanCardOneDark)" stroke-width="20" stroke-linejoin="bevel"></path>
                                            <defs>
                                                <linearGradient id="UpgradePlanCardOneDark" x1="187.747" y1="-11.283" x2="206.538" y2="167.497" gradientUnits="userSpaceOnUse">
                                                    <stop stop-color="#fff"></stop>
                                                    <stop offset="0.737" stop-color="#fff" stop-opacity="0"></stop>
                                                </linearGradient>
                                            </defs>
                                    ...
                                    <div class="row mt-8 align-items-center position-relative">
                                        <div class="mb-4 col-12">
                                            <div class="row align-items-center justify-content-between">
                                                <div class="flex-shrink-1 col">
                                                    <h4 class="mb-8 hp-text-color-black-0 fw-bold"> Get exclusive discounts for any payment method </h4>
                                                    <p class="hp-p1-body mb-0 hp-text-color-black-0"> by upgrading your plan to premium </p>
                                                </div>

                                                <div class="hp-flex-none w-auto col">
                                                    <button type="button" class="btn hp-float-right mt-16 mt-sm-0 border-0 hp-hover-bg-black-10 hp-bg-black-0 hp-text-color-black-100">
                                                        <span>Upgrade Now</span>
                                                    </button>
                                                </div>
                                            </div>
                        ...
                        <div class="col-12 col-sm-6">
                            <div class="overflow-hidden position-relative hp-bg-black-bg pt-24 px-24 pb-18 rounded-4">
                                <div class="position-absolute" style="height: 90%; bottom: 0px; right: -30px;">
                                    <svg fill="none" xmlns="http://www.w3.org/2000/svg" class="w-100 h-100">
                                        <path d="M384.797 85.179 194.619 10.257l46.816 86.462L113.23 44.63l129.884 138.803L69.597 116.68l60.469 87.899L2.651 171.657" stroke="url(#CreditCardNew)" stroke-width="20" stroke-linejoin="bevel"></path>
                                        <defs>
                                            <linearGradient id="CreditCardNew" x1="166.04" y1="17.382" x2="209.529" y2="191.807" gradientUnits="userSpaceOnUse">
                                                <stop stop-color="#fff"></stop>
                                                <stop offset="0.737" stop-color="#fff" stop-opacity="0"></stop>
                                            </linearGradient>
                                        </defs>
                            ...
                            <div class="overflow-hidden position-relative hp-bg-black-bg pt-24 px-24 pb-18 rounded-4">
                                ...
                                <div class="row" style="min-height: 158px;">
                                    <div class="col-xl-7 col-8">
                                        <p class="h5 mb-0 hp-text-color-black-0"> Check the Best Prices of New Models &amp; Boost Your Business </p>
                                        <button type="button" class="btn mt-24 border-0 hp-hover-bg-black-10 hp-bg-black-0 hp-text-color-black-100">
                                            <span>Upgrade Now</span>
                                        </button>
                                    </div>
                                </div>
                                            ...
                                            <div class="row g-8 align-items-center justify-content-center">
                                                <div class="col hp-flex-none w-auto">
                                                    <div class="avatar-item d-flex align-items-center justify-content-center bg-primary-3 rounded-circle" style="width: 36px; height: 36px;">
                                                        <img src="../../../app-assets/img/dashboard/analytics-marketing-team-1.svg">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col hp-flex-none w-auto">
                                                    <div class="avatar-item d-flex align-items-center justify-content-center bg-info-3 rounded-circle" style="width: 36px; height: 36px;">
                                                        <img src="../../../app-assets/img/dashboard/analytics-marketing-team-2.svg">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col hp-flex-none w-auto">
                                                    <div class="avatar-item d-flex align-items-center justify-content-center bg-black-60 rounded-circle" style="width: 36px; height: 36px;">
                                                        <img src="../../../app-assets/img/dashboard/analytics-marketing-team-3.svg">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col hp-flex-none w-auto">
                                                    <div class="avatar-item d-flex align-items-center justify-content-center bg-danger-3 rounded-circle" style="width: 36px; height: 36px;">
                                                        <img src="../../../app-assets/img/dashboard/analytics-marketing-team-4.svg">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col hp-flex-none w-auto">
                                                    <div class="avatar-item d-flex align-items-center justify-content-center bg-secondary-3 rounded-circle" style="width: 36px; height: 36px;">
                                                        <img src="../../../app-assets/img/dashboard/analytics-marketing-team-5.svg">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col hp-flex-none w-auto">
                                                    <div class="avatar-item d-flex align-items-center justify-content-center bg-warning-3 rounded-circle" style="width: 36px; height: 36px;">
                                                        <img src="../../../app-assets/img/dashboard/analytics-marketing-team-6.svg">
                                                    </div>
                                                </div>
                    ...
                    <div class="row g-32">
                        ...
                        <div class="col-12">
                            <div class="card border-none hp-card-2 px-12 py-16 hp-upgradePlanCardOne">
                                <div class="position-absolute top-0 start-0 w-100 h-100 hp-dark-none" style="background-image: url(../../../app-assets/img/dashboard/analytics-download-bg.png); background-size: cover; background-position: right center; z-index: -1;"></div>
                                <div class="position-absolute top-0 start-0 w-100 h-100 hp-dark-block mx-auto" style="background-image: url(../../../app-assets/img/dashboard/analytics-download-bg-dark.png); background-size: cover; background-position: right center; z-index: -1;"></div>
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col hp-flex-none w-auto position-absolute top-0 end-0 h-100 pe-0">
                                            <img src="../../../app-assets/img/dashboard/analytics-download-vector.svg" class="h-100 hp-dir-scale-x-n1" alt="Check the Best Prices of New Models &amp; Boost Your Business">
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="col-12 col-md-6 col-lg-4">
                    <div type="primary" class="hp-credit-card p-24 border-none rounded overflow-hidden position-relative">
                        <div class="hp-credit-card-circle position-absolute top-0 end-0" style="background-image: url(../../../app-assets/img/dashboard/credit-card-bg-circle.svg); background-size: contain; background-position: left bottom; background-repeat: no-repeat;"></div>

                        <div class="row justify-content-between d-flex flex-column" style="min-height: 224px;">
                            <div class="col-12">
                                <div class="row justify-content-between">
                                    <div class="col hp-flex-none w-auto" style="width: 45px;">
                                        <img src="../../../app-assets/img/dashboard/paypal-logo.svg" alt="Paypal">
                                    </div>
                                ...
                                <div class="row align-items-center justify-content-between mt-24">
                                    <div class="col hp-flex-none w-auto">
                                        <span class="h4 fw-medium hp-text-color-black-0">1.90124523</span>
                                    </div>

                                    <div class="col hp-flex-none w-auto">
                                        <img src="../../../app-assets/img/dashboard/mastercard-logo.png" alt="Mastercard">
                                    </div>
                                </div>
                            </div>

                            <div class="col-12 mt-24">
                                <div class="row align-items-center justify-content-between" style="margin-bottom: -3px;">
                                    <div class="col hp-flex-none w-auto">
                                        <span class="d-block hp-caption fw-medium text-black-20">Limit</span>
                                    </div>

                                    <div class="col hp-flex-none w-auto">
                                        <span class="d-block hp-caption fw-medium text-black-20">%30</span>
                                    </div>
                                </div>

                                <div class="progress mt-8" style="height: 8px;">
                                    <div class="progress-bar" role="progressbar" style="width: 30%;" aria-valuenow="30" aria-valuemin="0" aria-valuemax="100"></div>
                                </div>

                                <div class="row justify-content-between mt-24">
                                    <div class="col hp-flex-none w-auto">
                                        <span class="d-block hp-caption fw-medium text-black-10">Name on card</span>
                                        <span class="d-block h5 mb-0 fw-medium text-black-0">Edward Yıldırım</span>
                                    </div>

                                    <div class="col hp-flex-none w-auto text-end">
                                        <span class="d-block hp-caption fw-medium text-black-10">Expires</span>
                                        <span class="d-block h5 mb-0 fw-medium text-black-0">12/23</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="col-12 col-md-6 col-lg-4">
                    <div type="danger" class="hp-credit-card p-24 border-none rounded overflow-hidden position-relative">
                        <div class="hp-credit-card-circle position-absolute top-0 end-0" style="background-image: url(../../../app-assets/img/dashboard/credit-card-bg-circle.svg); background-size: contain; background-position: left bottom; background-repeat: no-repeat;"></div>
                        ...
                        <div class="row justify-content-between d-flex flex-column" style="min-height: 224px;">
                            <div class="col-12">
                                <div class="row justify-content-between">
                                    <div class="col hp-flex-none w-auto" style="width: 45px;">
                                        <img src="../../../app-assets/img/dashboard/netflix-logo.svg" alt="Netflix">
                                    </div>

                                    <div class="col hp-flex-none w-auto">
                                        <span class="hp-p1-body text-black-0">**** **** 1924</span>
                                    </div>
                                </div>

                                <div class="row align-items-center justify-content-between mt-24">
                                    <div class="col hp-flex-none w-auto">
                                        <span class="h4 fw-medium hp-text-color-black-0">1.90124524</span>
                                    </div>
                            ...
                            <div class="col-12 mt-24">
                                <div class="row align-items-center justify-content-between" style="margin-bottom: -3px;">
                                    ...
                                    <div class="col hp-flex-none w-auto">
                                        <span class="d-block hp-caption fw-medium text-black-20">%40</span>
                                    </div>
                                </div>
                                ...
                                <div class="row justify-content-between mt-24">
                                    ...
                                    <div class="col hp-flex-none w-auto text-end">
                                        <span class="d-block hp-caption fw-medium text-black-10">Expires</span>
                                        <span class="d-block h5 mb-0 fw-medium text-black-0">12/24</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="col-12 col-md-6 col-lg-4">
                    <div type="dark" class="hp-credit-card p-24 border-none rounded overflow-hidden position-relative">
                        <div class="hp-credit-card-circle position-absolute top-0 end-0" style="background-image: url(../../../app-assets/img/dashboard/credit-card-bg-circle.svg); background-size: contain; background-position: left bottom; background-repeat: no-repeat;"></div>
                        ...
                        <div class="row justify-content-between d-flex flex-column" style="min-height: 224px;">
                            <div class="col-12">
                                <div class="row justify-content-between">
                                    <div class="col hp-flex-none w-auto" style="width: 45px;">
                                        <img src="../../../app-assets/img/dashboard/google-play-logo.svg" alt="Google Play">
                                    </div>

                                    <div class="col hp-flex-none w-auto">
                                        <span class="hp-p1-body text-black-0">**** **** 1925</span>
                                    </div>
                                </div>

                                <div class="row align-items-center justify-content-between mt-24">
                                    <div class="col hp-flex-none w-auto">
                                        <span class="h4 fw-medium hp-text-color-black-0">1.90124525</span>
                                    </div>
                            ...
                            <div class="col-12 mt-24">
                                <div class="row align-items-center justify-content-between" style="margin-bottom: -3px;">
                                    ...
                                    <div class="col hp-flex-none w-auto">
                                        <span class="d-block hp-caption fw-medium text-black-20">%20</span>
                                    </div>
                                </div>
                                ...
                                <div class="row justify-content-between mt-24">
                                    ...
                                    <div class="col hp-flex-none w-auto text-end">
                                        <span class="d-block hp-caption fw-medium text-black-10">Expires</span>
                                        <span class="d-block h5 mb-0 fw-medium text-black-0">12/25</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="col-12 col-md-6 col-lg-4">
                    <div type="warning" class="hp-credit-card p-24 border-none rounded overflow-hidden position-relative">
                        <div class="hp-credit-card-circle position-absolute top-0 end-0" style="background-image: url(../../../app-assets/img/dashboard/credit-card-bg-circle.svg); background-size: contain; background-position: left bottom; background-repeat: no-repeat;"></div>
                        ...
                        <div class="row justify-content-between d-flex flex-column" style="min-height: 224px;">
                            <div class="col-12">
                                <div class="row justify-content-between">
                                    <div class="col hp-flex-none w-auto" style="width: 45px;">
                                        <img src="../../../app-assets/img/dashboard/amazon-logo.svg" alt="Amazon">
                                    </div>

                                    <div class="col hp-flex-none w-auto">
                                        <span class="hp-p1-body text-black-0">**** **** 1926</span>
                                    </div>
                                </div>

                                <div class="row align-items-center justify-content-between mt-24">
                                    <div class="col hp-flex-none w-auto">
                                        <span class="h4 fw-medium hp-text-color-black-0">1.90124526</span>
                                    </div>
                            ...
                            <div class="col-12 mt-24">
                                <div class="row align-items-center justify-content-between" style="margin-bottom: -3px;">
                                    ...
                                    <div class="col hp-flex-none w-auto">
                                        <span class="d-block hp-caption fw-medium text-black-20">%68</span>
                                    </div>
                                </div>
                                ...
                                <div class="row justify-content-between mt-24">
                                    ...
                                    <div class="col hp-flex-none w-auto text-end">
                                        <span class="d-block hp-caption fw-medium text-black-10">Expires</span>
                                        <span class="d-block h5 mb-0 fw-medium text-black-0">12/26</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="col-12 col-md-6 col-lg-4">
                    <div class="row g-32">
                        <div class="col-12">
                            <div class="d-flex justify-content-between flex-column rounded overflow-hidden hp-card-1 p-18" style="background-image: url(../../../app-assets/img/dashboard/paypal-bg.svg); background-size: cover; background-position: right center;">
                                <div class="row justify-content-between">
                                    <div class="col hp-flex-none w-auto">
                                        <div class="row align-items-center">
                                            <div class="col hp-flex-none w-auto">
                                                <img src="../../../app-assets/img/dashboard/paypal-logo.svg" alt="Paypal" height="25">
                                            </div>
                        ...
                        <div class="col-12">
                            <div class="d-flex justify-content-between flex-column rounded overflow-hidden hp-card-1 p-18" style="background-image: url(../../../app-assets/img/dashboard/googleplay-bg.svg); background-size: cover; background-position: right center;">
                                <div class="row justify-content-between">
                                    <div class="col hp-flex-none w-auto">
                                        <div class="row align-items-center">
                                            <div class="col hp-flex-none w-auto">
                                                <img src="../../../app-assets/img/dashboard/google-play-logo.svg" alt="Google Play" height="25">
                                            </div>
                ...
                <div class="col-12 col-md-6 col-lg-4">
                    <div class="row g-32">
                        <div class="col-12">
                            <div class="d-flex justify-content-between flex-column rounded overflow-hidden hp-card-1 p-18" style="background-image: url(../../../app-assets/img/dashboard/netflix-bg.svg); background-size: cover; background-position: right center;">
                                <div class="row justify-content-between">
                                    <div class="col hp-flex-none w-auto">
                                        <div class="row align-items-center">
                                            <div class="col hp-flex-none w-auto">
                                                <img src="../../../app-assets/img/dashboard/netflix-logo.svg" alt="Netflix" height="25">
                                            </div>

                                            <div class="col hp-flex-none w-auto">
                                                <span class="ms-12 hp-p1-body text-black-0">Netflix</span>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div class="col-12">
                            <div class="d-flex justify-content-between flex-column rounded overflow-hidden hp-card-1 p-18" style="background-image: url(../../../app-assets/img/dashboard/amazon-bg.svg); background-size: cover; background-position: right center;">
                                <div class="row justify-content-between">
                                    <div class="col hp-flex-none w-auto">
                                        <div class="row align-items-center">
                                            <div class="col hp-flex-none w-auto">
                                                <img src="../../../app-assets/img/dashboard/amazon-logo.svg" alt="Amazon" height="25">
                                            </div>
